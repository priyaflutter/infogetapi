                                  ...
                                  ElevatedButton(
                                      onPressed: () {
                                        Navigator.pushReplacement(
                                          ...
                                          builder: (context) {
                                            return urlll(
                                                view!.results,index,widget.main
                                            );
                                          },
                                        ));
                                      },
                                      ...
                                      ElevatedButton(
                                          onPressed: () {
                                            Navigator.pushReplacement(
                                              ...
                                              builder: (context) {
                                                return originnnn(
                                                    view!.results![index].origin!.url,widget.main);
                                              },
                                            ));
                                          },
                                          child:
                                      ...
                                      ElevatedButton(
                                          onPressed: () {
                                            Navigator.pushReplacement(
                                              ...
                                              builder: (context) {
                                                return location(
                                                    view!.results![index].location!.url,widget.main);
                                              },
                                            ));
                                          },
                                          child:
                                      ...
                                      ElevatedButton(
                                          onPressed: () {
                                            Navigator.pushReplacement(
                                              ...
                                              builder: (context) {
                                                return episodeeee(
                                                    view!.results![index].episode,widget.main);
                                              },
                                            ));
                                          },
                                          child:
